...
// ─── Public API — save contact form + send notification via Web3Forms ────────
...
const DEFAULT_GRAIN_VENDORS = [
  {vendor:'Farnam',       tag:'Horse Health · Fly Control · Hoof',     color:'#fff7ed', logoUrl:'', imgUrl:'https://sspark.genspark.ai/cfimages?u1=APQFxRzBJu5iRG%2Be6%2BZSpV1FnL4sqrLBF61a2yu9f2v8MWczCNQSIgESkQQbf8iA%2FzJ5bD%2B4dbPiHRXn15DqqHv%2B714IxEzsafrHOXaCIR6eRXI4IYLxCq93T4CTomVNN%2FntdtJmtTsf&u2=FBjs72IGitspXxu9&width=600'},
  ...
  {vendor:'Foran',        tag:'Equine Supplements · Performance',       color:'#f0fff4', logoUrl:'', imgUrl:'https://sspark.genspark.ai/cfimages?u1=CqkH4kIYABdVpnuxtR4bJqyehkIDpq3%2BdUQr%2FcbR38crltam%2BSVdBNtylFtOjAIbQiLcBWuAmcW42P%2F3dPIBpRuDsEF8u9g2sBQuyCtXS5dMZ3gwEWb6n0c%2BANfOj1jFDmw%3D&u2=erPuew9pmVC%2BvkXw&width=600'},
  {vendor:'Absorbine',    tag:'Liniment · ShowSheen · Joint Support',   color:'#fef9e8', logoUrl:'', imgUrl:'https://sspark.genspark.ai/cfimages?u1=hzEbAV4lPpykIa5X9lcQ4jr%2Fm9mpHj9nzVfssr4frp4kAfrI%2BXGE%2BRdSmGkNbIxpnhntyl9t3x6ivKuK9ssLhnalkfNY3MPhQuv3a11VUri%2F6A%3D%3D&u2=Y3f3oehzecr27oyj&width=600'},
  ...
  {vendor:'KeyFlow',      tag:'Low Starch · Performance · Senior',      color:'#f5f0ff', logoUrl:'', imgUrl:'https://sspark.genspark.ai/cfimages?u1=Vxz9lWjwxf2ZDBQw4sfUrkXEXV%2FJcZJZ%2FlYvsjswpMWnkrFwvhy8fUCTlInJHfSAcgbZhxIOUmLFM3lX4GvrTZqxqRl7aGNdVnzq9B9g7wZDh59ixKMAQk8Gp6G6Q1qmrlP2hg1jjhE%3D&u2=rkES%2F33%2By4pHTknJ&width=600'},
];
